...
void insertar_data(string info){
    string del =",";
    ...
    while (end_pos != -1) {
        ...
        cout << info.substr(start, end_pos - start) << endl; //substr nos ayuda a operar un string quitando los caracteres indicados
    ...
    cout << info.substr(start, end_pos - start)<<endl; // ahora la substraccion es desde el caracter siguiente a la coma hasta el final
